...
<div class="container mw-100">
    <div class="row justify-content-center">
        <div class="col mw-100">
            <div class="card">
                <div class="card-header fw-bold">{{ __('Tambah User') }}
...
@if ($message = Session::get('sukses'))
        ...
        @endif
                <div class="card-body">
                    <form method="post" action="{{route('user')}}/tambah/simpan" autocomplete="off">
                        @csrf
                    <div class="col-sm-6">
                        <table class="table-hover table-striped" width="100%">
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input type="text" name="nama" value="{{old('nama')}}" class="form form-control form-control-sm" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td>:</td>
                                <td>
                                    <input type="email" name="email" value="{{old('email')}}"  class="form form-control form-control-sm" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Role</td>
                                <td>:</td>
                                <td>
                                    <select class="form-select form-select-sm" name="role" value="{{old('role')}}" id="role" required>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input type="password" value="{{old('password')}}" id="password" name="pass" class="form form-control form-control-sm" required>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <div class="mt-3">
                            <center>
                            <button type="submit" class="btn btn-primary" style = "text-align:center" id="sub" onclick="return load()" disabled>
                                {{ __('Simpan') }}
                            </button>
                            </center>
